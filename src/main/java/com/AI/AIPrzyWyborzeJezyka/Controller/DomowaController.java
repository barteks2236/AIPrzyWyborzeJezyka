...
public class DomowaController {
	...
	public static int czyPomoglem = 1; // odpowiedz na koniec czy byla pomocna, w przeciwnym wypadku AI nie uczy się na
										// niej
	int wynik;
...
//		dane.add(new Data(Arrays.asList(new Integer[] { 1, 10, 1, 1 }), 0));
//		dane.add(new Data(Arrays.asList(new Integer[] { 0, 20, 1, 1 }), 1));
//		dane.add(new Data(Arrays.asList(new Integer[] { 0, 5, 0, 1 }), 0));
//		dane.add(new Data(Arrays.asList(new Integer[] { 1, 0, 1, 1 }), 0));
//		dane.add(new Data(Arrays.asList(new Integer[] { 0, 10, 0, 1 }), 0));
...
//		dane.add(new Data(Arrays.asList(new Integer[] { a, b, c, d }), czyPomoglem));
		...
		if (n == 1) {
			...
			if (n == 1 && (Odpowiedzi.daneOdp2.get(n).equals("3")
					|| Odpowiedzi.daneOdp2.get(n).toLowerCase().equals("mobile"))) {
				c += 1;
			}
			if (n == 1 && (Odpowiedzi.daneOdp2.get(n).equals("4")
		...
		if (n == 2) {
			if (n == 2 && (Odpowiedzi.daneOdp2.get(n).equals("1")
				...
				czyPomoglem = 1;
			} else if (n == 2 && (Odpowiedzi.daneOdp2.get(n).equals("2")
